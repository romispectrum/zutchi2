  ...
  return (
    <div className="h-screen w-full relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-gradient-to-br from-pink-100/20 via-purple-50/15 to-blue-100/20"
      />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(6)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-2 bg-gradient-to-r from-pink-200/40 to-purple-200/40 rounded-full"
            initial={{
      ...
      <div className="relative z-10 h-screen flex flex-col">
        ...
        {/* Social Action Button - Fixed position */}
        <motion.div
        ...
        >
          ...
          >
            ...
            <span className="text-sm sm:text-base">
              {isSocializing ? `Socializing... ${socialTimer}s` : 'Start Socializing'}
            </span>
            {isSocializing && <span className="text-xl">🎉</span>}
          </motion.button>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-white/80 to-white/60 backdrop-blur-lg rounded-2xl px-4 py-2 shadow-lg border border-white/40 inline-block">
            <p className="text-xs text-gray-600 flex items-center gap-2">
              <span>👥</span>
              Socializing boosts happiness and friendship!
              <span>💖</span>
            </p>
          </div>
        </motion.div>
